    ...
    <div className="mx-auto w-full max-w-[400px]">
      <div className="relative">
        <input
          ...
          className="h-8 w-full rounded-lg border bg-gray-1 py-3 pl-5 pr-14 text-dark outline-black duration-200 selection:bg-transparent"
        />
        <button
          onClick={copyToClipboard}
          className="absolute right-2 top-1/2 inline-flex h-8 -translate-y-1/2 items-center justify-center gap-1 rounded-md bg-dark px-2.5 py-1.5 text-sm font-medium text-black duration-200 hover:bg-dark/90"
        >
          <span>
            {copySuccess ? (
              <svg
